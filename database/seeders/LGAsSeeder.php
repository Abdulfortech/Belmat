    ...
    public function run(): void
    {
        $statesWithLGAs = [
            'Abia' => [
                ...
                'Obi Ngwa', 'Ohafia', 'Osisioma', 'Ugwunagbo', 'Ukwa East', 'Ukwa West', 'Umuahia North', 'Umuahia South', 'Umu Nneochi'
            ],
            'Adamawa' => [
            ...
            'Benue' => [
                ...
                'Obi', 'Ogbadibo', 'Ohimini', 'Oju', 'Okpokwu', 'Otukpo', 'Tarka', 'Ukum', 'Ushongo', 'Vandeikya'
            ],
            'Borno' => [
        ...
        foreach ($statesWithLGAs as $stateName => $lgas) {
            $state = State::where('title', $stateName)->first();
            if (!$state) continue;
            ...
            foreach ($lgas as $lga) {
                LocalGovernment::create([
                    'title' => $lga,
                    'state_id' => $state->id,
                    'code' => strtoupper(Str::slug($stateName . '-' . $lga)),
                    'status' => 'Active',
                ]);
            }
        }
